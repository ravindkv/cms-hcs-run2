...
# with command line options: Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGEN-00039-fragment.py --python_filename HIG-RunIISummer20UL16wmLHEGEN-00039_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:HIG-RunIISummer20UL16wmLHEGEN-00039.root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --step LHE,GEN --geometry DB:Extended --era Run2_2016 --no_exec --mc -n 50
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGEN-00039-fragment.py nevts:50'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL16wmLHEGEN-00039.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL16wmLHEGEN-00039_inLHE.root'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
                ...
                '37:onMode = off', 
                '37:onIfAny = 4', #new test gkole
                #'37:onIfMatch = 35 24', # this doesnot work because H+ decays to (24 and 25)
                '37:doForceWidth = on',
                '24:onMode = off', #keep this in case some events decays to 35
                '24:onIfAny = 11 13 15'
        ),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/afs/cern.ch/user/g/gkole/public/xRavindra/HToCS/ChargedHiggsToCS_M120_slc7_amd64_gcc700_CMSSW_10_6_0_tarball.tar.xz'),
    # args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/madgraph/V5_2.3.3/ChargedHiggsToCS_M120/v1/ChargedHiggsToCS_M120_tarball.tar.xz'),
